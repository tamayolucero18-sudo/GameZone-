...
Nos centramos en ofrecer una experiencia de juego pura y simple, sin sistemas complicados ni tutoriales extensos' ],
  ...
  6  => ['nombre'=>'Elden Ring',   'categoria'=>'Acción',     'plataforma'=>'PS5, PS4, PC, XBOX Series X/S, XBOX ONE',    'precio'=>1299, 'anio'=>2022, 'estudio'=>'FromSoftware',           'desc'=>'Elden Ring nos llevará a un mundo convulso, complejo y sangriento. En esta ocasión, el equipo japonés ha aumentado la escala del título, trasladando y depurando su conocida jugabilidad a una nueva dimensión. El nuevo universo del videojuego será mucho más grande, más que ningún otro juego anterior de FromSoftware, con extensiones de terreno llenas de enemigos, criaturas extrañas y desafíos.'],
